...
// Code Here
const total = myNumbers.reduce((total, value) => total + value);
//////////////////PROBLEM 17////////////////////
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map((name) => {
  if (name !== "George") {
    return "George";
  }
});
...
// Code Here
const enemies = people.filter((person) => {
...
// Code Here
const totallyAwesome = people.reduce((total, obj) => {
  return total + obj.awesomeLevel;
}, 0);
